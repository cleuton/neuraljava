...
public class ClassificationIrisSave {
	private static final Logger log = Logger.getLogger(ClassificationIrisSave.class.getName());
	private void modelBuild() throws IOException, InterruptedException {
        ...
        File locationToSave = new File("/tmp/irisModelSave.zip");     
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		ClassificationIrisSave cIris = new ClassificationIrisSave();
		cIris.modelBuild();
