...
public class ClassificationIris {
	private static final Logger log = Logger.getLogger(ClassificationIris.class.getName());
	private void modelBuild() throws IOException, InterruptedException {
        ...
        System.out.println("Esperdo: 1, previsto: " + net.output(vetor));
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		ClassificationIris cIris = new ClassificationIris();
		cIris.modelBuild();
